...
} from '../src/document/document-utils';
import type { ComponentRegistryLike } from '../src/validation/validator';
...
describe('STORA-062: Importer .stora dengan Preflight Validation', () => {
  ...
  describe('Acceptance Criteria 3: Legacy document migration during import', () => {
    it('detects legacy 0.1.0 schema version and migrates to 1.0.0', async () => {
      ...
      expect(preflight.migrationPath).toEqual(['0.1.0', '1.0.0', '1.1.0', '1.2.0']);
      ...
      expect(importRes.document.version).toBe('1.2.0');

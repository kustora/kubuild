  ...
  return (
    ...
    >
      <div className="relative w-full max-w-4xl h-[85vh] flex flex-col bg-slate-900 border border-slate-700/80 rounded-2xl shadow-2xl overflow-hidden text-slate-100 font-sans">
        ...
        <div className="flex items-center justify-between px-6 py-2.5 border-b border-slate-800 bg-slate-900/60 shrink-0 overflow-x-auto gap-2">
          ...
          {currentPipeline && (
            <div className="flex items-center gap-3 shrink-0 ml-auto text-xs text-slate-400">
              ...
              <button
                ...
                className="p-1 rounded text-slate-500 hover:text-red-400 hover:bg-red-500/10 transition flex items-center gap-1 cursor-pointer"
              >
                <Trash2 className="w-3.5 h-3.5" />
                <span className="text-[11px]">Clear Trigger</span>
              </button>
            </div>
          )}
        </div>
